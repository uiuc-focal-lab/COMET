...
class InstructionsDependencies:
    ...
    def make_predicates_inst_dep_num_insts(self):  # this has forward edges removed, with no differentiation between the data dependencies
        ...
        # exit(0)
        # edge_labels = nx.get_edge_attributes(self.data_dependency_graph, 'label')
    ...
    def perturb_inst_dep_num_insts(self, present_tokens, p, n, use_stoke=False):
        '''
